...
namespace WindowsFormsApp1
{
    public static class FirebaseInitialization
    {
        ...
        static FirebaseInitialization()
        {
            try
            {
                string credentialsPath = @"C:\Users\WINDOWS 10\source\repos\Hestia\WindowsFormsApp1\WindowsFormsApp1\FirebaseJSONFile\tuluyan-user-login-firebase-adminsdk-e385i-a56a1fe29d.json";
